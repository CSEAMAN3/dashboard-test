...
//       id UUID DEFAULT uuid-generate_v4() PRIMARY KEY,
...
//     await client.sql`CREATE EXTENTION IF NOT EXISTS "uuid-ossp"`

//     // create the "customers" table if it does not exist
//     const createTable = await client.sql`
//       CREATE TABLE IF NOT EXIST customers(
//         id UUID DEFAULT uuid-generate_v4() PRIMARAY KEY,
...
//     // Create the "revnue" table if it does not exist
//     const createTable = await client.sql`
